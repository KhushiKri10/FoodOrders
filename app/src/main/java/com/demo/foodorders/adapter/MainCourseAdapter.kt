...
class MainCourseAdapter (val userList: ArrayList<StarterItem>) : RecyclerView.Adapter<MainCourseAdapter.ViewHolder>() {

    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainCourseAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: MainCourseAdapter.ViewHolder, position: Int) {
